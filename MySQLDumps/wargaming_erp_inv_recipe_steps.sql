...
--
-- Dumping data for table `inv_recipe_steps`
--

LOCK TABLES `inv_recipe_steps` WRITE;
/*!40000 ALTER TABLE `inv_recipe_steps` DISABLE KEYS */;
/*!40000 ALTER TABLE `inv_recipe_steps` ENABLE KEYS */;
UNLOCK TABLES;
