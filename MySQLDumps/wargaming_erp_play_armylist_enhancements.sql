...
--
-- Dumping data for table `play_armylist_enhancements`
--

LOCK TABLES `play_armylist_enhancements` WRITE;
/*!40000 ALTER TABLE `play_armylist_enhancements` DISABLE KEYS */;
INSERT INTO `play_armylist_enhancements` VALUES (2,23,'8367002',25),(3,24,'8367003',20);
/*!40000 ALTER TABLE `play_armylist_enhancements` ENABLE KEYS */;
UNLOCK TABLES;
