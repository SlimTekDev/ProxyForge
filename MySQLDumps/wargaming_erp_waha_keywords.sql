...
--
-- Dumping data for table `waha_keywords`
--

LOCK TABLES `waha_keywords` WRITE;
/*!40000 ALTER TABLE `waha_keywords` DISABLE KEYS */;
/*!40000 ALTER TABLE `waha_keywords` ENABLE KEYS */;
UNLOCK TABLES;
