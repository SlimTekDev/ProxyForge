...
--
-- Dumping data for table `play_match_tracking`
--

LOCK TABLES `play_match_tracking` WRITE;
/*!40000 ALTER TABLE `play_match_tracking` DISABLE KEYS */;
/*!40000 ALTER TABLE `play_match_tracking` ENABLE KEYS */;
UNLOCK TABLES;
