...
--
-- Dumping data for table `inv_resin_inventory`
--

LOCK TABLES `inv_resin_inventory` WRITE;
/*!40000 ALTER TABLE `inv_resin_inventory` DISABLE KEYS */;
/*!40000 ALTER TABLE `inv_resin_inventory` ENABLE KEYS */;
UNLOCK TABLES;
