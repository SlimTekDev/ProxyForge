...
--
-- Dumping data for table `inv_stl_bits`
--

LOCK TABLES `inv_stl_bits` WRITE;
/*!40000 ALTER TABLE `inv_stl_bits` DISABLE KEYS */;
/*!40000 ALTER TABLE `inv_stl_bits` ENABLE KEYS */;
UNLOCK TABLES;
