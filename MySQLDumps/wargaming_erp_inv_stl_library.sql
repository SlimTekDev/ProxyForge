...
--
-- Dumping data for table `inv_stl_library`
--

LOCK TABLES `inv_stl_library` WRITE;
/*!40000 ALTER TABLE `inv_stl_library` DISABLE KEYS */;
/*!40000 ALTER TABLE `inv_stl_library` ENABLE KEYS */;
UNLOCK TABLES;
