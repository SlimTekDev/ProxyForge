...
--
-- Dumping data for table `inv_physical_models`
--

LOCK TABLES `inv_physical_models` WRITE;
/*!40000 ALTER TABLE `inv_physical_models` DISABLE KEYS */;
/*!40000 ALTER TABLE `inv_physical_models` ENABLE KEYS */;
UNLOCK TABLES;
