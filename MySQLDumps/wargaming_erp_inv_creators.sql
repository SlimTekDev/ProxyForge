...
--
-- Dumping data for table `inv_creators`
--

LOCK TABLES `inv_creators` WRITE;
/*!40000 ALTER TABLE `inv_creators` DISABLE KEYS */;
/*!40000 ALTER TABLE `inv_creators` ENABLE KEYS */;
UNLOCK TABLES;
