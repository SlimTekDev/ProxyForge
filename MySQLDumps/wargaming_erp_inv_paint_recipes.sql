...
--
-- Dumping data for table `inv_paint_recipes`
--

LOCK TABLES `inv_paint_recipes` WRITE;
/*!40000 ALTER TABLE `inv_paint_recipes` DISABLE KEYS */;
/*!40000 ALTER TABLE `inv_paint_recipes` ENABLE KEYS */;
UNLOCK TABLES;
