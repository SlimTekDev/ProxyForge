...
--
-- Dumping data for table `play_mission_cards`
--

LOCK TABLES `play_mission_cards` WRITE;
/*!40000 ALTER TABLE `play_mission_cards` DISABLE KEYS */;
/*!40000 ALTER TABLE `play_mission_cards` ENABLE KEYS */;
UNLOCK TABLES;
